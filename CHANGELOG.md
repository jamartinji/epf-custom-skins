...
- Added new warlock skins

## [1.4.3] - 2026-09-01

### Added

- Added death knight frames

## [1.4.2] - 2026-08-28

### Added

- Added demon hunter frames
...
- Updated and simplified skin definitions
- Updated alternative devourer skin
...
- Added rogue frames and extra pirated themed frames

### Removed

- Old hunter texture file

## [1.3.10] - 2026-08-10

### Added

- Added survival hunter frames

### Changed

- Updated Hunter frames and changed MM default frame.
- Updated protection frame with paladin crest.

## [1.3.9] - 2026-08-07

### Added

- Added new priest frames

## [1.3.8] - 2026-08-05

### Added

- Added new shaman frames
...
- Added new paladin frames

## [1.3.5] - 2026-07-09

### Added

- Added new monk frames
...
- Added new balance druid skin.

## [1.3.1] - 2026-06-01

### Added

- **Copy from target** for fast setups in overrides.
...
- **Copy from target** button in the override editor (enabled when you have a target).
...
- Added new Death Knight Skin provided by [Benjiro_Blue](https://legacy.curseforge.com/members/benjiro_blue/projects)

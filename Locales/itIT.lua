...
EPF_CustomSkins_Locales.itIT = {
    ...
    OverrideIntro = "Assegna una texture per una combinazione classe/spec/razza/fazione/sesso. Gli override hanno priorità in modalità Automatica.",
    OverrideListTitle = "Override salvati",
    OverrideEditorTitle = "Modifica override",
    OverrideClass = "Classe",
    OverrideSpec = "Specializzazione",
    OverrideRace = "Razza",
    OverrideRaceEarthen = "Terrigeno",
    ...
    OverrideSlotEmpty = "Slot override",
    OverrideTooltipCriteria = "Criteri di corrispondenza",
    OverrideTooltipTexture = "Texture",
    OverridePanelLoadError = "Impossibile caricare il pannello Overrides. Attiva gli errori di script (/console scriptErrors 1) e ricarica.",
}

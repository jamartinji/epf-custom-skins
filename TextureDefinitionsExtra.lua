...
local extraEntries = {
    -- Cell (1,1) (1)
    { id = "extraserpe", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Serpent",
        layout = {
            layers = {
    ...
    -- Cell (1,2) (2)
    { id = "extrawinge", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Winged Moon",
        layout = {
            layers = {
     ...
     --Cell (1,3) (3)
    { id = "extragryph", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Gryphon",
        layout = {
            layers = {
    ...
    -- Cell (1,4) (4)
    { id = "extrawyver", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Wyvern",
        layout = {
            layers = {
    ...
    -- Cell (2,1) (5) — row 2
    { id = "extradrago", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Dragon",
        layout = {
            layers = {
    ...
    -- Cell (2,2) (6)
    { id = "extravalky", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Valkyr",
        layout = {
            layers = {
    ...
    -- Cell (2,3) (7)
    { id = "extragryph1", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Gryphon 2",
        layout = {
            layers = {
    ...
    -- Cell (2,4) (8)
    { id = "extrawyver1", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Wyvern 2",
        layout = {
            layers = {
    ...
    -- Cell (3,1) (9) — row 3
    { id = "extracatac", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Cataclysm Dragon",
        layout = {
            layers = {
    ...
    -- Cell (3,2) (10)
    { id = "extradualw", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Dual Wings",
        layout = {
            layers = {
    ...
    -- Cell (3,3) (11)
    --{ class = "CUSTOM", name = "extra", singleLayer = true, displayName = "TBD",
    --    layout = {
    --        layers = {
    ...
    --},
    -- Cell (3,4) (12)
    { id = "extramanti", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Manticore",
        layout = {
            layers = {
    ...
    -- Left half (cells 1–2)
    { id = "extrawinge1", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Winged Moon Wide",
        layout = {
            layers = {
    ...
    { id = "extravalky1", class = "CUSTOM", name = "extra", singleLayer = true, displayName = "Valkyr Wide",
        layout = {
            layers = {

...
EPF_CustomSkins_Locales.koKR = {
    ...
    OverrideIntro = "직업/특성/종족/진영/성별 조합에 텍스처를 지정합니다. Overrides는 자동 모드에서 우선 적용됩니다.",
    OverrideListTitle = "저장된 Overrides",
    OverrideEditorTitle = "Override 편집",
    OverrideClass = "직업",
    OverrideSpec = "특성",
    OverrideRace = "종족",
    OverrideRaceEarthen = "대지인",
    OverrideRaceHaranir = "하라니르",
    OverrideFaction = "진영",
    OverrideSex = "성별",
    OverrideMale = "남성",
    OverrideFemale = "여성",
    ...
    OverrideSlotEmpty = "Override 슬롯",
    OverrideTooltipCriteria = "일치 조건",
    OverrideTooltipTexture = "텍스처",
    OverridePanelLoadError = "Overrides 패널을 불러오지 못했습니다. 스크립트 오류를 켜고 (/console scriptErrors 1) UI를 다시 불러오세요.",
}

...
EPF_CustomSkins_Locales.zhCN = {
    ...
    OverrideIntro = "为职业/专精/种族/阵营/性别组合指定纹理。Overrides 在自动模式下优先于默认规则。",
    OverrideListTitle = "已保存的 Overrides",
    OverrideEditorTitle = "编辑 Override",
    OverrideClass = "职业",
    OverrideSpec = "专精",
    OverrideRace = "种族",
    OverrideRaceEarthen = "土灵",
    OverrideRaceHaranir = "哈拉里尔",
    OverrideFaction = "阵营",
    OverrideSex = "性别",
    OverrideMale = "男性",
    OverrideFemale = "女性",
    ...
    OverridePanelLoadError = "无法加载 Overrides 面板。请启用脚本错误（/console scriptErrors 1）后重载界面。",
}

...
local entries = {
    ...
    { id = "dhdevdevou", class = "DEMONHUNTER", name = "dh_devourer", displayName = "Devourer Horns", layout = "top", pointOffset = { 170, 0 }, },
    ...
    { id = "druidold", class = "DRUID", name = "druid", displayName = "Druid crest", layout = "bot" },

...
local entries = {
    ...
    { id = "druid", class = "DRUID", name = "druid", ext = "png",
        layout = "top",
    },
    { id = "evoker", class = "EVOKER", name = "evoker", ext = "png", layout = "dual" },
    { id = "hunter", class = "HUNTER", name = "hunter_base&bm", ext = "png",
        layout = "top",
    },
    { id = "mage", class = "MAGE", name = "mage", ext = "png",
        layout = "bot",
    },
    { id = "monk", class = "MONK", name = "monk_base&brew", ext = "png",
        layout = "top",
        pointOffset = { 172, 10 },
    },
    { id = "priest", class = "PRIEST", name = "priest", ext = "png",
        layout = "top",
    },
    { id = "rogue", class = "ROGUE", name = "rogue_base&subtley", ext = "png",
        layout = "top",
    },
    { id = "shaman", class = "SHAMAN", name = "shaman_base&resto", ext = "png",
        layout = "top",
    },
    { id = "warlock", class = "WARLOCK", name = "warlock", ext = "png",
        layout = { preset = "dual", layers = { { pointOffset = { 38, -4 } }, { pointOffset = { 168, -4 } } } },
    },
    { id = "warrior", class = "WARRIOR", name = "warrior_base&protection", ext = "png",
        layout = "top",
    },
}
